...
namespace QualisysRealTime.Unity
{
    public class RTClient : IDisposable
    {
        ...
        //    if (GUI.Button(new Rect(Screen.width / 2 - 10, Screen.height / 2 - 50, 200, 50), "MoCap Connect"))
        //    {
        //        Connect("127.0.0.1", 22222, true, true, false, false, false, false);
        //        connectNow = true;
        //    }
        //}

        //public void ConnectionNow()
        //{
        //    Connect("127.0.0.1", 22222, true, true, false, false, false, false);
        //    connectNow = true;
        //}

        //public void StartMoCapConnection()
        //{
        //    Connect("127.0.0.1", 22222, true, true, false, false, false, false);
        //    connectNow = true;
        //}
